...
run a0_plan        no_intervention --reasoning_prompt=True --steps 2
run a1_const       constitution    --steps 2
run a0_plan_think  no_intervention --reasoning_prompt=True --enable_thinking=True --max_completion_length 4096 --steps 2
